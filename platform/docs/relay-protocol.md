...
Status: **contract draft; Relay transport is not enabled in this phase**.
...
- The agent can only dispatch to the fixed loopback Codex Control Center port.
...
3. The future desktop app generates a device key pair locally.
