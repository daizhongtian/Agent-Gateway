  ...
  return <div className="admin-shell">
    <header className="admin-topbar">
      ...
      <div className="admin-top-actions">
        <span className="admin-identity"><b>{user.displayName}</b><small>{user.email}</small></span>
