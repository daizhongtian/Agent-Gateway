    ...
    <section className="auth-panel">
      <div className="auth-card">
        ...
        <form onSubmit={submit} className="auth-form">
          {mode === 'register' && <label>显示名称<input autoComplete="name" value={displayName} onChange={(event) => setDisplayName(event.target.value)} placeholder="你的名称" minLength={2} maxLength={80} required /></label>}
